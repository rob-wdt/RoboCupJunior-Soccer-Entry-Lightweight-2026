...
{
  _rotation_speed = _direction * (linear_speed * cosf(_location_angle + _angle_coef * angle) + angular_speed);
  // _rotation_speed = _direction * (linear_speed * (cosf(_location_angle + _angle_coef * angle) + angular_speed)); // Это второй вариант, я не знаю пока какой нужен
  //------------------------------------------------^-----------------------------------------------------------^--
}
